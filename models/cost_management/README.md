python sample.py csv/other.csv csv/other_100.csv 100
python combine.py csv/other_100.csv csv/cost_management.csv csv/combined.csv
python split.py csv/combined.csv csv/train.csv csv/test.csv
python main.py csv/train.csv model_cost_management.pkl --test_file csv/test.csv --test_output csv/predictions.csv
