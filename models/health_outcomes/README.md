...
python combine.py csv/other_150.csv csv/health_outcomes.csv csv/combined.csv
python split.py csv/combined.csv csv/train.csv csv/test.csv
python main.py csv/train.csv model_health_outcomes.pkl --test_file csv/test.csv --test_output csv/predictions.csv
