...
python combine.py csv/other_120.csv csv/supply_chain.csv csv/combined.csv
python split.py csv/combined.csv csv/train.csv csv/test.csv
python main.py csv/train.csv model_supply_chain.pkl --test_file csv/test.csv --test_output csv/predictions.csv
